...
namespace Gwen.Renderer
{
    ...
    public class SFML : Renderer.Base, ICacheToTexture
    {
        ...
        */
        ...
        public override void DrawTexturedRect(Texture t, Rectangle targetRect, System.Drawing.Color clr, float u1 = 0, float v1 = 0, float u2 = 1, float v2 = 1)
        {
            ...
            Color col = new Color(clr.R, clr.G, clr.B, clr.A);
            DrawTexturedRect(tex, targetRect, col, u1, v1, u2, v2);
        }

        protected void DrawTexturedRect(SFMLTexture tex, Rectangle targetRect, Color clr, float u1 = 0, float v1 = 0, float u2 = 1, float v2 = 1)
        {
            ...
            m_VertexCache[m_CacheSize++] = new Vertex(new Vector2f(rect.X, rect.Y), clr, new Vector2f(u1, v1));
            m_VertexCache[m_CacheSize++] = new Vertex(new Vector2f(right, rect.Y), clr, new Vector2f(u2, v1));
            m_VertexCache[m_CacheSize++] = new Vertex(new Vector2f(right, bottom), clr, new Vector2f(u2, v2));
            m_VertexCache[m_CacheSize++] = new Vertex(new Vector2f(rect.X, bottom), clr, new Vector2f(u1, v2));
        }
        ...
        public  void LoadSFMLTexture(Texture uitexture, SFMLTexture sftexture)
        {
            ...
            uitexture.Width = (int)sftexture.Size.X;
            uitexture.Height = (int)sftexture.Size.Y;

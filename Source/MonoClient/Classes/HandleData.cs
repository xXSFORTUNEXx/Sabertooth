...
namespace Mono_Client
{
    public static class HandleData
    {
        ...
        public static void HandleDataMessage()
        {
            ...
            if ((incMSG = MonoClient.netClient.ReadMessage()) != null)
            {
            ...
            MonoClient.netClient.Recycle(incMSG);
        }
        ...
        static void HandleActivationRequest(NetIncomingMessage incMSG)
        {
            ...
            //gui.CreateActivateWindow(canvas); SFML
        }
        ...
        static void HandleOpenChest(NetIncomingMessage incMSG)
        {
            ...
            if (!players[myIndex].inChest)
            {
                ...
                //gui.CreateChestWindow(canvas); SFML
                gui.menuWindow.Show();
        ...
        {
            //canvas.Dispose(); SFML
            MonoClient.netClient.Shutdown("Disconnect");
            Exit(0);
        }
        ...
        static void HandleOpenChat(NetIncomingMessage incMSG)
        {
            ...
            if (!players[myIndex].inChat)
            {
                players[myIndex].chatNum = index;
                players[myIndex].inChat = true;
                //gui.CreateNpcChatWindow(canvas, index - 1); SFML
            }          
        }
        ...
        static void HandleOpenShop(NetIncomingMessage incMSG)
        {
            ...
            if (!players[myIndex].inShop)
            {
                ...
                //gui.CreateShopWindow(canvas); SFML
                gui.menuWindow.Show();
                gui.packTab.Press(gui.menuTabs);
                gui.charTab.Hide();
                gui.equipTab.Hide();
        ...
        static void HandleOpenBank(NetIncomingMessage incMSG)
        {
            if (!players[myIndex].inBank)
            {
                ...
                //gui.CreateBankWindow(canvas); SFML
                gui.menuWindow.Show();
                gui.packTab.Press(gui.menuTabs);
                gui.charTab.Hide();
                gui.equipTab.Hide();
        ...
        {
            if (MonoClient.netClient.ServerConnection != null) { return; }
        ...
        static void HandleLoginData(NetIncomingMessage incMSG)
        {
            ...
            //canvas.DeleteAllChildren(); SFML
            //gui.CreateLoadingWindow(canvas); SFML
            gui.Ready = false;
        }

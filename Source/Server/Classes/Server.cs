        ...
        public static void CreateDatabase()
        {
            ...
            if (Server.DBType == Globals.SQL_DATABASE_REMOTE.ToString())
            {
                ...
                using (var sql = new SqlConnection(connection))
                {
                    ...
                    command += "(OWNER VARCHAR(25), NAME TEXT, CLIP INTEGER, MAXCLIP INTEGER, SPRITE INTEGER, DAMAGE INTEGER, ARMOR INTEGER, TYPE INTEGER, ATTACKSPEED INTEGER, RELOADSPEED INTEGER,";
                    ...
                    command += "(OWNER VARCHAR(25), SLOT INTEGER, NAME TEXT, SPRITE INTEGER, DAMAGE INTEGER, ARMOR INTEGER, TYPE INTEGER, ATTACKSPEED INTEGER, RELOADSPEED INTEGER, HEALTHRESTORE INTEGER, HUNGERRESTORE INTEGER,";

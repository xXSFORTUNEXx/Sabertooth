...
namespace SabertoothServer
{
    public class Spell
    {
        ...
        public Spell(string name, 
            int icon, int level, int vital, int hpcost, int mpcost, int cooldown, int casttime, int charges, int totaltick, int tickint, int spelltype, int range,
            bool hot, bool dot, bool aoe)
        {
            Name = name;

...
namespace UpdateServer
{
    public static class Logging
    {
        ...
        public static void WriteMessageLog(string logMessage, string logType = "Update Server")
        {
        ...
        /// <param name="logMessage"></param>
        /// <param name="logType"></param>
        public static void WriteMessageLogLine(string logMessage, string logType = "Update Server")
        {
            if (!Directory.Exists("Logs")) { Directory.CreateDirectory("Logs"); }
            string dir = "Logs/" + logType + " " + DateTime.Now.ToString("yyyMMdd") + ".txt";
            string final = "[" + DateTime.Now.ToString("HH:mm:ss") + "] - " + logMessage;
        ...
        /// <param name="logMessage"></param>
        /// <param name="logType"></param>
        public static void WriteLog(string logMessage, string logType = "Update Server")
        {
            if (!Directory.Exists("Logs")) { Directory.CreateDirectory("Logs"); }
            string dir = "Logs/" + logType + " " + DateTime.Now.ToString("yyyMMdd") + ".txt";
            string final = "[" + DateTime.Now.ToString("HH:mm:ss") + "] - " + logMessage;
